...
class Products with ChangeNotifier{
  ...
  var url = 'https://graduateshopapp-default-rtdb.firebaseio.com/products.json?auth=$authToken&$filteredString';
  try{
   ...
   url = 'https://graduateshopapp-default-rtdb.firebaseio.com/userFavourites/$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product product) async{
    final url = 'https://graduateshopapp-default-rtdb.firebaseio.com/products.json?auth=$authToken';
    try{
  ...
  Future<void> updateProduct(String id ,Product newProduct) async{
    ...
    if(prodIndex >= 0){
      final url = 'https://graduateshopapp-default-rtdb.firebaseio.com/products/$id.json?auth=$authToken';
